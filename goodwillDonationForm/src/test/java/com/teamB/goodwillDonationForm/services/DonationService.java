...
public class DonationServiceTest {
    ...
    @Autowired
    private com.teamB.goodwillDonationForm.services.DonationService donationService;
...
//    }
    ...
    public void setUp(){
        ...
        inputDonation = new Donation(donors, donationTypes, "11/27/2000" );
        mockDonation1 = new Donation(donors, donationTypes, "11/27/1998" );
        mockDonation1.setId(1L);
        mockDonation2 = new Donation(donors, donationTypes, "12/12/1978");
